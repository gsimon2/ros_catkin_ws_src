...
#
#
#		Just got to home location and turning around and going back through the maze
#
#
#

# Now change direction and do it again
print('Turning around and doing it again!')
time.sleep(1)
