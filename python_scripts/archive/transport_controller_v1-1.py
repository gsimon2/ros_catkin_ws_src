...
parser.add_argument('-mw' , '--multiple_worlds', action='store_true', help='Sets it so the rover will be spawned in a random world')
...
# Handle spawning the rover in a randomly selected world
